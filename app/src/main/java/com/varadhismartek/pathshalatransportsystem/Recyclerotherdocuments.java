...
public class Recyclerotherdocuments extends RecyclerView.Adapter<Recyclerotherdocuments.MyViewHolder> implements OnImageSelect{
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == 200 && resultCode == Activity.RESULT_OK ) {
            ...
            Addvehicle.othrdocarraylist.set(pos,getPathFromUri(filePath));
            Uri imageuri = Uri.parse("android.resource://"+context.getPackageName()+"/drawable/folderad");
            Addvehicle.othrdocarraylist.add(getPathFromUri(imageuri));
            notifyDataSetChanged();
        }
    ...
    @Override
    public void onBindViewHolder(Recyclerotherdocuments.MyViewHolder holder, final int position)
    {
        ...
        holder.cv_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Addvehicle.othrdocarraylist.size()>1)
                {
                    //removing the string from the arraylist
                    Addvehicle.othrdocarraylist.remove(position);
                    notifyDataSetChanged();
                }
    ...
    {
        return Addvehicle.othrdocarraylist.size();
    }
