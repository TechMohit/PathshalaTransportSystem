...
public class Recyclervehiclefitness extends RecyclerView.Adapter<Recyclervehiclefitness.MyViewHolder>{

    public List<Team_Pojo> team_pojoList;
    Context context;

    public Recyclervehiclefitness(Context context, List<Team_Pojo> team_pojos)
    {
    ...
    @Override
    public void onBindViewHolder(Recyclervehiclefitness.MyViewHolder holder, int position)
    {
